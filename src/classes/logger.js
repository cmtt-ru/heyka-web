...
const DEFAULT_STYLE = 'font-size: 0.65rem; font-weight: 700; font-family: Helvetica;' +
  'padding: 3px 5px 2px; border-radius: 5px; margin: 0 2px';
...
class Logger {
   ...
   */
  info() {
    console.log(`%ci%c${this.module}`,
      'font-family: Helvetica; font-size: 0.8rem; border: 1px solid #2bc3ff;' +
      'color: #2bc3ff; padding: 1px 6.25px 0px;  margin-right: 5px; border-radius: 20px', this.style, ...arguments);
  }
